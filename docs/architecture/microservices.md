...
| Recommendation Service | Node 24 / Express | Rule-based CBT/wellbeing/urgent-support recommendation selection | Internal | None | `npm run dev -w @echo/recommendation-service` | `/health` |
