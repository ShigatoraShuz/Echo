-- Route auth-user bootstrap persistence to service-owned user tables.
-- Public duplicate application tables are retained for historical migrations,
-- but new ECHO feature state must not be initialized there.
