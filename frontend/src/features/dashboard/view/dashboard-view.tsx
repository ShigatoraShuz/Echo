...
export function DashboardView() {
  ...
  const { userProfile, journalEntries, latestEntry, moodTrend, riskTrend, weeklyDigest, quickActions } = data;
            ...
            <div className="grid min-w-0 gap-5 lg:grid-cols-2">
              ...
              <EchoCard title="Current distress signal" description="This score is a support signal, not a diagnosis.">
                {latestEntry ? (
                  ...
                  <p className="text-sm text-muted-foreground">No recent entries to display.</p>
                )}
              </EchoCard>
            </div>
          </EchoReveal>
