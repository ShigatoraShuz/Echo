...
export function FacialInsightsView() {
  ...
  return (
    <div className="space-y-6">
      <VerifiedFeatureGate featureName="Facial trend analysis">
        <PageHeader
          label="Insights"
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
            ...
            <div className="space-y-6">
              ...
              <DataChartCard
                title="Aggregated facial trends"
                description="Mock trend cards for opted-in sessions only."
                points={vm.facialTrend.map((point) => ({ label: point.label, value: point.value }))}
              />
              <PrivacyNotice />
            </div>
          </div>
