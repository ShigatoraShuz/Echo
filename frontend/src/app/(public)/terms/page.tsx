import { HeartHandshake, ListChecks, ShieldAlert, Sparkles } from "lucide-react";
...
export default function TermsPage() {
  return (
    <PublicTextPage
      eyebrow="Using ECHO"
      title="Terms of use"
      description="A summary of ECHO's terms. Registration presents the current versioned documents for review."
      imageKey="calmChairPlant"
    >
      <div className="space-y-4">
        <PolicyBlock title="Supportive use, not clinical care" icon={HeartHandshake}>
        ...
        <PolicyBlock title="AI-assisted features" icon={Sparkles}>
        ...
        <PolicyBlock title="Your choices" icon={ListChecks}>
        ...
        <PolicyBlock title="Emergency situations" icon={ShieldAlert}>
