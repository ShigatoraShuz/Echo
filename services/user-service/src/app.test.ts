...
const dependencies = { onboarding: controllerService, settings: controllerService, verification: controllerService, registration: controllerService, access: controllerService, notifications: controllerService, database: { from: () => ({ insert: () => ({ select: () => ({ single: async () => ({ data: {}, error: null }) }) }) }) } } as any;
