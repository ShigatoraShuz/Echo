...
const environmentSchema = z.object({
  ...
  ANALYSIS_PROVIDER: z.enum(["mock", "ai-service"]).default("mock"),
  AI_SERVICE_URL: z.string().url().default("http://localhost:8000"),
  AI_SERVICE_TOKEN: z.string().trim().min(1).default(""),
